...
This makes computational cytometry work unaccessible if you don't have powerful hardware.
...
To make this easy to use for everyone, I created the [*cytoSNOW*](https://github.com/davnovak/cytoSNOW) R package.
Each function in it is carefully documented, and it runs a number of sanity checks on the input parameters that allow you to spot potential errors easily.
...
To plot a comparison of running times using a stacked bar plot, `tidyverse` and `ggtext`
